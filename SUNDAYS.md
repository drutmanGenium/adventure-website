...
│   ├── not-found-content.tsx      # Branded 404 page with hero background, navigation links
...
| `app/not-found.tsx` | Custom 404 page using Next.js App Router `not-found` convention. Renders branded error page with full-bleed mountain hero image, bilingual copy, and CTA buttons linking to `/` and `/actividades` |
...
| `/*` (404) | `NotFoundPage` | Branded 404 error page with Patagonian mountain hero background and links to home/activities |
